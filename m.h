...
void mLookAt(vec3 eye, vec3 center, vec3 up, mat4 dest);

void mRotateYMatr(float angle, mat4 dest);

void mTranslateMatr(float x, float y, float z, mat4 dest);

void mMat4Mul(mat4 m1, mat4 m2, mat4 dest);
